...
export function createChallenge(input: CreateStepUpInput): Promise<StepUpChallenge> {
...
export function resendFactor(challengeId: string, factorId: string): Promise<null> {
  return api.post<null>(`/attendee/step-up/${challengeId}/resend`, { factor_id: factorId });
}
