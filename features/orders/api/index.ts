import type { EventOrder, OrdersPage, OrderStatus } from '@/features/orders/types';
...
export function getEventOrder(eventId: string, orderId: string): Promise<EventOrder> {
